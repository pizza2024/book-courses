...
import type { FormStudentType, FormTeacherType, LoginData, ModalAdmin, ModalCourse, ModalPublishedCourse, ModalStudent, ModalTeacher } from "common";
...
export const apiPostTeacher = (data: FormTeacherType) => request.post<{ success: Boolean; rows: ModalStudent[] }>('/api/teacher', data)
